...
def minio_server():
    ...
    try:
        ...
        for i in range(60):  # 60 attempts = 30 seconds
            try:
...
class TestS3Integration:
    """Integration tests for S3 class with real MinIO server."""

    def test_s3_instance_creation(self, s3_config):
    ...
    def test_connection_and_list_empty_bucket(self, s3_config):
        ...
        try:
            ...
            assert any(
                ...
                for error in ["nosuchbucket", "404", "not found"]
            )

    def test_transfer_archive_success(self, s3_config, mock_archive):
    ...
    def test_transfer_archive_dry_run(self, s3_config, mock_archive):
    ...
    def test_list_archives_after_upload(self, s3_config, mock_archive):
    ...
    def test_thinning_delete_all(self, s3_config, mock_archive):
        ...
        print(
            f"Thinning result: retained={thin_result.archivesRetained}, deleted={thin_result.archivesDeleted}"
        )
    ...
    def test_thinning_keep_some(self, s3_config):
    ...
    def test_error_handling_invalid_host(self):
    ...
    def test_progress_with_large_file(self, s3_config, capsys):
